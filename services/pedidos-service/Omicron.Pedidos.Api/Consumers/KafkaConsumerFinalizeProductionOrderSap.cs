// <summary>
// <copyright file="KafkaConsumerFinalizeProductionOrderSap.cs" company="Axity">
...
namespace Omicron.Pedidos.Api.Consumers
{
    ...
    /// <summary>
    /// KafkaConsumerFinalizeProductionOrderSap.
    /// </summary>
    public class KafkaConsumerFinalizeProductionOrderSap : BackgroundService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KafkaConsumerFinalizeProductionOrderSap"/> class.
        /// </summary>
        ...
        public KafkaConsumerFinalizeProductionOrderSap(IConfiguration configuration, ILogger logger, IServiceProvider serviceProvider)
        {
            this.configuration = configuration;
            this.consumer = ConsumerUtils.GetConsumerConfig(configuration, KafkaConstants.KafkaTopicNameFinalizeProductionOrderSap);
            this.logger = logger;
        ...
        private async Task StartConsumer(CancellationToken stoppingToken)
        {
            ...
            Guid kafkaProcessId;
            var logBase = KafkaConstants.LogBaseKafkaConsumerFinalizeProductionOrderSap;
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                try
                {
                    ...
                    var lista = new List<string> { this.configuration[string.Format(KafkaConstants.KafkaEhName, KafkaConstants.KafkaTopicNameFinalizeProductionOrderSap)] };
                    ...
                    if (!string.IsNullOrEmpty(consumerResult.Message.Value))
                    {
                        ...
                        await pedidoFacade.FinalizeProductionOrdersOnSapAsync(productionOrderProcessing);
