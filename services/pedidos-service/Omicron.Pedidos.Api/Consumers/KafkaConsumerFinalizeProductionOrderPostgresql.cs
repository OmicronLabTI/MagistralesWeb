// <summary>
// <copyright file="KafkaConsumerFinalizeProductionOrderPostgresql.cs" company="Axity">
...
namespace Omicron.Pedidos.Api.Consumers
{
    ...
    /// </summary>
    public class KafkaConsumerFinalizeProductionOrderPostgresql : BackgroundService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KafkaConsumerFinalizeProductionOrderPostgresql"/> class.
        /// </summary>
        ...
        public KafkaConsumerFinalizeProductionOrderPostgresql(IConfiguration configuration, ILogger logger, IServiceProvider serviceProvider)
        {
            this.configuration = configuration;
            this.consumer = ConsumerUtils.GetConsumerConfig(configuration, KafkaConstants.KafkaTopicNameFinalizeProductionOrderPostgresql);
            this.logger = logger;
        ...
        private async Task StartConsumer(CancellationToken stoppingToken)
        {
            ...
            Guid kafkaProcessId;
            var logBase = KafkaConstants.LogBaseKafkaConsumerFinalizeProductionOrderPostgresql;
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                try
                {
                    ...
                    var lista = new List<string> { this.configuration[string.Format(KafkaConstants.KafkaEhName, KafkaConstants.KafkaTopicNameFinalizeProductionOrderPostgresql)] };
                    ...
                    if (!string.IsNullOrEmpty(consumerResult.Message.Value))
                    {
                        ...
                        await pedidoFacade.FinalizeProductionOrdersOnPostgresqlAsync(productionOrderProcessing);
