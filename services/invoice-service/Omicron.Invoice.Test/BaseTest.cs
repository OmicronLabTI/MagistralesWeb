    ...
    public abstract class BaseTest
    {
        ...
        public IEnumerable<InvoiceModel> GetAllInvoices()
            => new List<InvoiceModel>()
            {
                ...
                new InvoiceModel { Id = "8a8c6e71-d57e-4adb-8672-e7800f859295", DxpOrderId = "DXP-1010", IdInvoiceError = 5, CreateDate = DateTime.UtcNow.AddDays(-1), AlmacenUser = "168783d1-9892-4318-8e3e-03f98d3bf384", Status = "Enviada a crear", IdFacturaSap = null, TypeInvoice = "No Gen�rica", BillingType = "Completa", InvoiceCreateDate = null, ErrorMessage = null, UpdateDate = null, RetryNumber = 0, Type = "Autom�tica", ManualChangeApplied = false, IsProcessing = false, Payload = "{}" },
                new InvoiceModel { Id = "750aab4f-4c2f-4f6d-a5bf-be0cd75b3bd7", DxpOrderId = "098a4f0b-a655-42dc-8b62-b7b0f13f4dc9", IdInvoiceError = 5, CreateDate = DateTime.UtcNow.AddDays(-1), AlmacenUser = "168783d1-9892-4318-8e3e-03f98d3bf384", Status = "Enviada a crear", IdFacturaSap = null, TypeInvoice = "No Gen�rica", BillingType = "Completa", InvoiceCreateDate = null, ErrorMessage = null, UpdateDate = null, RetryNumber = 0, Type = "Autom�tica", ManualChangeApplied = false, IsProcessing = false, Payload = "{}" },
                new InvoiceModel { Id = "37d61da2-0c1d-4df0-b6a0-f740274e3893", DxpOrderId = "3e4aba7d-4496-431c-83f6-c085d836e4c5", IdInvoiceError = 5, CreateDate = DateTime.UtcNow.AddDays(-1), AlmacenUser = "168783d1-9892-4318-8e3e-03f98d3bf384", Status = "Enviada a crear", IdFacturaSap = null, TypeInvoice = "No Gen�rica", BillingType = "Completa", InvoiceCreateDate = null, ErrorMessage = null, UpdateDate = null, RetryNumber = 0, Type = "Autom�tica", ManualChangeApplied = false, IsProcessing = false, Payload = "{}" },
                new InvoiceModel { Id = "1ba6a7b1-f92a-4d6b-90b0-e3b83ee7ca40", DxpOrderId = "96fea349-734a-4966-b9d9-8821327d18b8", IdInvoiceError = 5, CreateDate = DateTime.UtcNow.AddDays(-1), AlmacenUser = "168783d1-9892-4318-8e3e-03f98d3bf384", Status = "Enviada a crear", IdFacturaSap = null, TypeInvoice = "No Gen�rica", BillingType = "Completa", InvoiceCreateDate = null, ErrorMessage = null, UpdateDate = null, RetryNumber = 0, Type = "Autom�tica", ManualChangeApplied = false, IsProcessing = false, Payload = "{}" },
                new InvoiceModel { Id = "be99fa81-dcbb-481c-891a-1ef08088e349", DxpOrderId = "1d4811d8-4a31-4fd3-bd00-dc91f6ca4ada", IdInvoiceError = 5, CreateDate = DateTime.UtcNow.AddDays(-1), AlmacenUser = "168783d1-9892-4318-8e3e-03f98d3bf384", Status = "Creación exitosa", IdFacturaSap = 150833, TypeInvoice = "No Gen�rica", BillingType = "Completa", InvoiceCreateDate = null, ErrorMessage = null, UpdateDate = null, RetryNumber = 0, Type = "Autom�tica", ManualChangeApplied = false, IsProcessing = false, Payload = "{}" },
        ...
        public List<InvoiceSapOrderModel> GetInvoiceSapOrderModel()
            => new List<InvoiceSapOrderModel>()
            {
                ...
                new InvoiceSapOrderModel { Id = 8, SapOrderId = 177299, IdInvoice = "37d61da2-0c1d-4df0-b6a0-f740274e3893" },
                new InvoiceSapOrderModel { Id = 9, SapOrderId = 177304, IdInvoice = "1ba6a7b1-f92a-4d6b-90b0-e3b83ee7ca40" },
            };
    }
}
