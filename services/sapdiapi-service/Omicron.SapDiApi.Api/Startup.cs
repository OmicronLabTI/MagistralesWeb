...
[assembly: Microsoft.Owin.OwinStartup(typeof(Omicron.SapDiApi.Api.Startup))]

namespace Omicron.SapDiApi.Api
{
    ...
    public class Startup
    {
        ...
        {
            return Omicron.SapDiApi.Api.Configuration.ApiConfig.Register();
        }
    }
}