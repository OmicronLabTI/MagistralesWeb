// <summary>
// <copyright file="UpdateProductionOrderDto.cs" company="Axity">
...
{
    /// <summary>
    /// the class UpdateProductionOrderDto.
    /// </summary>
    public class UpdateProductionOrderDto : BaseProductionOrder
    {
          /// <summary>
        ...
        public List<BaseCreateProductionOrderLineDto> ProductionOrderLines { get; set; }
    }
}