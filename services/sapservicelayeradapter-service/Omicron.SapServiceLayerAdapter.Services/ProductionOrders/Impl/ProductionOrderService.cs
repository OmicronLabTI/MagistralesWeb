        ...
        public async Task<ResultModel> FinalizeProductionOrderInSap(List<CloseProductionOrderDto> productionOrdersToFinalize)
        {
            ...
            foreach (var productionOrder in productionOrdersToFinalize)
            {
                ...
                try
                {
                    ...
                    string lockKey = $"lock:finalizeproductionorderinsap:{productionOrder.ProductionOrderId}";
                    ...
                    if (!acquired)
                    {
                        ...
                        this.logger.Information(LogsConstants.AlreadyBeingProcessedByAnotherPod, logBase, productionOrder.ProductionOrderId, lockKey, podName);
                    }
