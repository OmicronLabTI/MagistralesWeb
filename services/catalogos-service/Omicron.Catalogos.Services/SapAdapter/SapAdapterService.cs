...
namespace Omicron.Catalogos.Services.SapAdapter
{
    ...
    /// Class sap adapter.
    /// </summary>
    public class SapAdapterService : ISapAdapterService
    {
        /// <summary>
        /// Client Http.
        /// </summary>
        ...
        public SapAdapterService(HttpClient httpClient, ILogger logger)
        {
        ...
        public async Task<ResultDto> Post(object data, string route)
        {
            ...
            {
                result = await ServiceUtils.GetResponse(response, this.logger, "Error peticion post sapadapter service");
            }
