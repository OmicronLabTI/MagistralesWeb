...
namespace Omicron.Catalogos.DataAccess.DAO.Catalog
{
    ...
    public class CatalogDao : ICatalogDao
    {
        ...
        public async Task<bool> InsertSortingRoute(List<SortingRouteModel> sortingroute)
        {
            this.databaseContext.SortingRouteModel.UpdateRange(sortingroute);
            await ((DatabaseContext)this.databaseContext).SaveChangesAsync();
        ...
        public async Task<List<SortingRouteModel>> GetSortingRoutes(List<string> classifications)
        {
