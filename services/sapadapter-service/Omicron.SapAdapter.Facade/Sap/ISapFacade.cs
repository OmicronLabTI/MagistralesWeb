...
namespace Omicron.SapAdapter.Facade.Sap
{
    ...
    public interface ISapFacade
    {
        ...
        /// <param name="pedidosId">the order ir.</param>
        /// <returns>A <see cref="Task{TResult}"/> representing the result of the asynchronous operation.</returns>
        Task<ResultDto> GetPedidoWithDetailAndDxp(List<int> pedidosId);
        ...
        Task<ResultDto> GetValidationQuatitiesOrdersFormula(List<int> orderIds);
        ...
        Task<ResultDto> GetBatchesComponentsByItemCodeAndWarehouses(Dictionary<string, string> parameters);
        ...
        /// <returns>the data.</returns>
        Task<ResultDto> GetMostCommonComponents(Dictionary<string, string> parameters);
        ...
        Task<ResultDto> GetOrderInformationByTransaction(Dictionary<string, string> parameters);
