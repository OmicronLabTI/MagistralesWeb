...
namespace Omicron.SapAdapter.Facade.Sap
{
    ...
    public class SapAlmacenFacade : ISapAlmacenFacade
    {
        ...
        /// <inheritdoc/>
        public async Task<ResultDto> GetInvoiceProducts(string invoiceId, string type, List<int> deliveriesIds)
        {
            return this.mapper.Map<ResultDto>(await this.sapInvoiceService.GetInvoiceProducts(invoiceId, type, deliveriesIds));
        }
        ...
        /// <inheritdoc/>
        public async Task<ResultDto> GetDeliveryDetaiByOrders(List<int> ordersId)
        {
            return this.mapper.Map<ResultDto>(await this.almacenService.GetDeliveryDetaiByOrders(ordersId));
        }
    }
}
