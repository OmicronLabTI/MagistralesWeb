...
namespace Omicron.SapAdapter.Test
{
    ...
    public abstract class BaseTest
    {
        ...
        public List<OrderModel> GetOrderModel()
        {
            ...
            {
                new OrderModel { PedidoId = 100, AsesorId = 1, Codigo = "Codigo", DocNum = 100, FechaFin = DateTime.Now, FechaInicio = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1), Medico = "Medico", PedidoStatus = "C", AtcEntry = 1, OrderType = "MN", DocNumDxp = "A1", Patient = "paciente", ShippingAddressName = "Nombre de la direcci�n", ClientType = "institucional", Canceled = "N" },
        ...
        public List<RawMaterialRequestDetailModel> GetRawMaterialRequestDetailModel()
        {
            ...
            {
               new RawMaterialRequestDetailModel { DocEntry = 1, ItemCode = "ITM 1", Description = "Descripci�n", Quantity = 1.234M, TargetWarehosue = "MG", Unit = "Paquete" },
               new RawMaterialRequestDetailModel { DocEntry = 2, ItemCode = "ITM 2", Description = "Descripci�n", Quantity = 2.234M, TargetWarehosue = "MG", Unit = "Paquete" },
               new RawMaterialRequestDetailModel { DocEntry = 3, ItemCode = "ITM 3", Description = "Descripci�n", Quantity = 3.234M, TargetWarehosue = "MG", Unit = "Paquete" },
               new RawMaterialRequestDetailModel { DocEntry = 4, ItemCode = "ITM 4", Description = "Descripci�n", Quantity = 4.234M, TargetWarehosue = "MG", Unit = "Paquete" },
               new RawMaterialRequestDetailModel { DocEntry = 5, ItemCode = "ITM 5", Description = "Descripci�n", Quantity = 5.234M, TargetWarehosue = "MG", Unit = "Paquete" },
               new RawMaterialRequestDetailModel { DocEntry = 6, ItemCode = "ITM 6", Description = "Descripci�n", Quantity = 6.234M, TargetWarehosue = "MG", Unit = "Paquete" },
            };
        }
