    ...
    public abstract class BaseTest
    {
        ...
        public List<OrderModel> GetOrderModel()
        {
            return new List<OrderModel>
            {
                ...
                new OrderModel { PedidoId = 101, AsesorId = 1, Cliente = "cliente", Codigo = "Codigo", DocNum = 101, FechaFin = DateTime.Today.AddDays(1), FechaInicio = DateTime.Today, Medico = "Medico", PedidoStatus = "O", OrderType = "MN" },
