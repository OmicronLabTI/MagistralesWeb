...
namespace Omicron.SapAdapter.DependencyInjection
{
    ...
    public static class DependencyInjector
    {
        ...
        {
            Services.AddDbContext<DatabaseContext>(options => options.UseSqlServer(configuration.GetConnectionString(nameof(DatabaseContext)), action => action.EnableRetryOnFailure(3)), ServiceLifetime.Transient);
        }
