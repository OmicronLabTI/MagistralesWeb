...
namespace Omicron.SapAdapter.Services.Sap
{
    ...
    public interface ISapService
    {
        ...
        /// <param name="pedidosIds">the detail.</param>
        /// <returns>the data.</returns>
        Task<ResultModel> GetPedidoWithDetailAndDxp(List<int> pedidosIds);
        ...
        Task<ResultModel> GetValidationQuatitiesOrdersFormula(List<int> orderIds);
        ...
        /// <returns>A <see cref="Task{TResult}"/> representing the result of the asynchronous operation.</returns>
        Task<ResultModel> GetInvoicesByRemissionId(List<int> remissions);
    }
}
