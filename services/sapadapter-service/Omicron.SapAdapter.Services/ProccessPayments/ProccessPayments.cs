// <summary>
// <copyright file="ProccessPayments.cs" company="Axity">
...
namespace Omicron.SapAdapter.Services.ProccessPayments
{
    ...
    /// </summary>
    public class ProccessPayments : IProccessPayments
    {
        /// <summary>
        /// Client Http.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProccessPayments" /> class.
        /// </summary>
        /// <param name="httpClient">Client Http.</param>
        /// <param name="logger">the logger.</param>
        public ProccessPayments(HttpClient httpClient, ILogger logger)
        {
        ...
        /// <inheritdoc/>
        public async Task<ResultDto> PostProccessPayments(object objectToSend, string route)
        {
            ResultDto result;
