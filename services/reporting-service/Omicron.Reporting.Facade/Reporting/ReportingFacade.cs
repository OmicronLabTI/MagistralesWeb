...
namespace Omicron.Reporting.Facade.Request
{
    ...
    public class ReportingFacade : IReportingFacade
    {
        ...
        public List<FileResultDto> CreateRawMaterialRequestPdf(RawMaterialRequestDto request, bool preview)
        {
            return this.mapper.Map<List<FileResultDto>>(
                this.reportingService.CreateRawMaterialRequestPdf(
