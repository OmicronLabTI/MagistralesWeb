...
builder.ConfigureServices((hostContext, services) =>
{
    ...
    services.AddTransient<IOrderDivisionProcessHandler, OrderDivisionProcessHandler>();
    services.AddTransient<IRedisService, RedisService>();
});

var host = builder.Build();
using var scope = host.Services.CreateScope();
var handler = scope.ServiceProvider.GetRequiredService<IOrderDivisionProcessHandler>();
