...
export const Endpoints = {
  ...
  pedidos: {
    ...
    detailCarousel: `${environment.baseUrl}/api/sapadapter/orders/details`,
    ...
    rangeDateInit: `${environment.baseUrl}/api/catalogos/params/contains/field?MagistralesDaysToLook=MagistralesDaysToLook&ProductNoLabel=ProductNoLabel`,
