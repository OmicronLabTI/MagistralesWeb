...
import { MaterialRequestMock } from 'src/mocks/materialRequest';
describe('RequestSupplies Component', () => {
  ...
  beforeEach(async(() => {
    ...
    localStorageServiceSpy.getMaterialRequestData.and.returnValue({
      ...new MaterialRequestData(),
      products: [{
