...
import {
  IAutomaticBillingRes, IManualRetrieResponse, IMissingSAPOrdersResponse,
  IUpdateManualChangeRes, ManualRetryequest
} from '../model/http/invoices';
import { Endpoints } from 'src/environments/endpoints';
import { automaticBillingResponseMock, changesAppliedConfirmMock, missingSAPOrdersResponseMock } from 'src/mocks/invoicesMock';
import { of } from 'rxjs';
...
export class InvoicesService {
  ...
  getMissingSAPOrders(params: string) {
    return this.consumeService.httpGet<IMissingSAPOrdersResponse>(`${Endpoints.invoices.missingSAPOrders}?${params}`);
  }
}
