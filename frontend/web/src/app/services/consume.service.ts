...
export class ConsumeService {
  ...
  private validateLoading(status: boolean): void {
    this.counterPetitions = status ? this.counterPetitions + 1 : this.counterPetitions - 1;
    if (this.counterPetitions === CONST_NUMBER.zero) {
