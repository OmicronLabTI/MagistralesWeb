...
class InboxTest: XCTestCase {
    ...
    override func setUp() {
        ...
        qfbName: "", technicalSign: true, hasTechnicalAssigned: false, orderRelationType: "Completa")
        ...
        finishedLabel: false, patientName: "NamePatient 1", clientDxp: "clientDxp 1",
        shopTransaction: "emnjkd", qfbName: "", technicalSign: true, hasTechnicalAssigned: false, orderRelationType: "Completa")
        orderItemCodeEmpty = Order( areBatchesComplete: true, productionOrderId: 89995, baseDocument: 60284,
            ...
            technicalSign: true, hasTechnicalAssigned: false, orderRelationType: "Completa")
        orderTest1 = Order( areBatchesComplete: true, productionOrderId: 90006, baseDocument: 60288,
        container: "Selecciona una...", tag: "Selecciona una...", plannedQuantity: 2, startDate: "24/09/2020",
        finishDate: "25/09/2020", descriptionProduct: "Agua de rosas 48%  agua de hamamelis 48%   propilenglicol 4%",
        statusId: 1, itemCode: "1132   120 ML", productCode: nil, destiny: "Local", hasMissingStock: true,
        finishedLabel: false, patientName: "NamePatient 3", clientDxp: "clientDxp 3", shopTransaction: "emnjkd",
        qfbName: "", technicalSign: true, hasTechnicalAssigned: false, orderRelationType: "Completa")
        orderTest2 = Order( areBatchesComplete: true, productionOrderId: 89997, baseDocument: 60284,
        container: "PRINCESS/DISCTOP", tag: "PERSONALIZADA", plannedQuantity: 1, startDate: "22/09/2020",
        finishDate: "30/09/2020", descriptionProduct: "Aceite de Lima 20%, Vaselina", statusId: 1,
        itemCode: "2573   30 ML", productCode: nil, destiny: "Local", hasMissingStock: false, finishedLabel: false,
    ...
    func testGroupedWithSimilarityOrWithoutSimilarityShouldBeGroupedWithoutSimilarity() {
        ...
        let order = Order(areBatchesComplete: true, productionOrderId: 89852, baseDocument: 0, container: "",
                          ...
                          patientName: "NamePatient", clientDxp: "clientDxp",
                          shopTransaction: "emnjkd", qfbName: "", technicalSign: true, hasTechnicalAssigned: false, orderRelationType: "Completa")
        data["BA-01"] = [order]
        // When
