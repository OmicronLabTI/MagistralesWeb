...
//  Omicron
//
//  Created by Daniel Velez on 17/04/23.
...
struct AppFontName {
  static let regular = "FrutigerNextLT-Regular"
  static let bold = "FrutigerNextLT-Medium"
  static let lightAlt = "FrutigerNextLT-Light"
}
//customise font
