...
class LoginViewController: UIViewController {
    ...
    func initComponents() {
        ...
        self.loginDescriptionLabel.font = .fontDefaultBold(24)
        ...
        self.loginButtonDescriptionLabel.font = .fontDefaultBold(18)
