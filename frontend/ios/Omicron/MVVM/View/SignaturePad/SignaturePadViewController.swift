...
class SignaturePadViewController: UIViewController {
    ...
    func initComponents() {
        ...
        signatureTitleLabel.font = UIFont(name: FontsNames.FrutigerNextLTBold, size: 22)
        clearButton.setTitle(CommonStrings.clear, for: .normal)
        clearButton.titleLabel?.font = UIFont(name: FontsNames.FrutigerNextLTRegular, size: 17)
        ...
        acceptButton.titleLabel?.font = UIFont(name: FontsNames.FrutigerNextLTRegular, size: 17)
    }
}
